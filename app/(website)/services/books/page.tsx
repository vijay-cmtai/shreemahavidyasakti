    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <section className="relative py-20 text-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10 text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">
            {t("books.hero.title", "Sacred Books Collection")}
          </h1>
          <p className="text-xl md:text-2xl opacity-90 mb-8">
            {t(
              "books.hero.subtitle",
              "Sacred Books of Astrology & Spirituality"
            )}
          </p>
          <p className="text-lg opacity-80 mb-8 max-w-3xl mx-auto">
            {t(
              "books.hero.description",
              "Authentic knowledge from ancient scriptures and modern experts"
            )}
          </p>
          <div className="flex flex-wrap justify-center gap-6 text-sm opacity-90">
            <div className="flex items-center gap-2">
              ...
              <span>
                {t("books.hero.features.authentic", "Authentic Content")}
              </span>
            </div>
            <div className="flex items-center gap-2">
              <span className="text-2xl">🙏</span>
            ...
            <div className="flex items-center gap-2">
              <span className="text-2xl">📖</span>
              <span>
                {t("books.hero.features.languages", "Multiple Languages")}
              </span>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white rounded-3xl p-8 shadow-2xl border border-orange-100">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-gray-800 mb-2">
                {t("books.search.title", "🔍 Find Your Perfect Book")}
              </h2>
              <p className="text-gray-600">
                {t(
                  "books.search.subtitle",
                  "Filter by category, language and author"
                )}
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-4 gap-6 mb-8">
              <div>
                ...
                <div className="relative">
                  ...
                  <Input
                    placeholder={t(
                      "books.search.placeholders.search",
                      "Search books, author, or description..."
                    )}
                    value={searchTerm}
              ...
              <div>
                ...
                >
                  <SelectTrigger className="py-3 border-2 border-orange-200 focus:border-orange-400 rounded-xl">
                    <SelectValue
                      placeholder={t(
                        "books.search.placeholders.category",
                        "Select Category"
                      )}
                    />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="all">
                      {t(
                        "books.search.options.allCategories",
                        "All Categories"
                      )}
                    </SelectItem>
              ...
              <div>
                ...
                <Select value={language} onValueChange={setLanguage}>
                  <SelectTrigger className="py-3 border-2 border-orange-200 focus:border-orange-400 rounded-xl">
                    <SelectValue
                      placeholder={t(
                        "books.search.placeholders.language",
                        "Select Language"
                      )}
                    />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="all">
                      {t("books.search.options.allLanguages", "All Languages")}
                    </SelectItem>
            ...
            <div className="flex flex-wrap justify-center gap-3">
              <div className="text-sm text-gray-600 mr-4">
                {t("books.search.quickFilters", "Quick Filters:")}
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-800 mb-4">
              {t("books.collection.title", "Available Books Collection")}
            </h2>
            <p className="text-gray-600">
              {t(
                  ...
                  <div className="grid grid-cols-2 gap-2 mb-4 text-sm">
                    <div className="bg-gray-50 px-3 py-2 rounded-lg text-center">
                      <div className="text-xs text-gray-600">
                        {t("books.labels.pages", "Pages")}
                      </div>
                      <div className="font-semibold text-sm">{book.pages}</div>
                    </div>
                    <div className="bg-gray-50 px-3 py-2 rounded-lg text-center">
                      <div className="text-xs text-gray-600">
                        {t("books.labels.language", "Language")}
                      </div>
              ...
              {books.length === 0 ? (
                <div>
                  <p className="text-gray-500 text-lg mb-4">
                    No books available from the API.
                  </p>
                  <p className="text-sm text-gray-400 mb-4">
                    Please check if the backend server is running and the API
      ...
      <section className="py-16 bg-gradient-to-r from-orange-50 to-red-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-800 mb-4">
              {t("books.features.title", "Why Choose Our Books?")}
            </h2>
            <p className="text-lg text-gray-600">
              {t("books.features.subtitle", "Authentic and sacred knowledge")}
            </p>
          </div>
            ...
            {[
              {
                icon: "✅",
                title: t(
                  "books.features.items.authentic.title",
                  "Authentic Content"
                ),
                desc: t(
                  "books.features.items.authentic.desc",
              ...
              {
                icon: "🔄",
                title: t("books.features.items.returns.title", "Easy Returns"),
                desc: t(
                  "books.features.items.returns.desc",
              ...
              },
              {
                icon: "🚚",
                title: t(
                  "books.features.items.delivery.title",
                  "Fast Delivery"
                ),
                desc: t(
                  "books.features.items.delivery.desc",
      ...
      <section className="py-16 bg-gradient-to-r from-orange-600 to-red-500 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button
              variant="outline"
              className="border-white text-white px-8 py-3 rounded-full font-semibold hover:bg-white hover:text-orange-600"
            >
              {t("books.cta.call", "Call: +91 9700380000")}
            </Button>
          </div>
        </div>
      </section>
            ...
            <CardContent className="p-6">
              ...
              <div className="bg-orange-50 p-4 rounded-lg mb-6 border border-orange-200">
                <h3 className="font-bold text-lg text-orange-800 mb-2">
                  {t("books.checkout.orderSummary", "📋 Order Summary")}
                </h3>
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between text-lg font-bold text-orange-600 pt-2 border-t">
                    <span>
                      {t("books.checkout.totalAmount", "Total Amount:")}
                    </span>
              ...
              <form onSubmit={handleCheckoutSubmit} className="space-y-4">
                <div className="text-center mb-6">
                  <h3 className="text-xl font-bold text-gray-800 mb-2">
                    {t(
                      "books.checkout.deliveryInfo",
                      "📝 Delivery Information"
                    )}
                  </h3>
                  <p className="text-gray-600">
                    {t(
                      "books.checkout.deliveryDesc",
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      📞{" "}
                      {t(
                        "books.checkout.alternativeMobile",
                        "Alternative Mobile"
                      )}
                    </label>
                    <Input
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">
                    📝{" "}
                    {t(
                      "books.checkout.specialInstructions",
                ...
                <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                  ...
                  <div className="text-sm text-blue-700 space-y-1">
                    ...
                    <p>
                      •{" "}
                      {t(
                        "books.checkout.codAvailable",
                        "COD available (Cash on Delivery)"
                      )}
                    </p>
                    <p>
                      •{" "}
                      {t("books.checkout.returnPolicy", "30-day return policy")}
                    </p>
                    <p>
                      •{" "}
                      {t(
                        "books.checkout.authenticGuarantee",
                        "Authentic content guaranteed"
                      )}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4 pt-4">
                  ...
                  >
                    {t(
                      "books.checkout.proceedToPayment",
                      "💳 Proceed to Payment"
                    )}
                  </Button>
                </div>
