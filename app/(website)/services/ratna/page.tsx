...
export default function Ratna() {
  ...
  const priceRanges = [
    ...
    {
      id: "5000-10000",
      name: t("ratna.priceRanges.5000to10000", "₹5,000 - ₹10,000"),
    },
    {
      id: "10000-20000",
      name: t("ratna.priceRanges.10000to20000", "₹10,000 - ₹20,000"),
    },
  ...
  const sortOptions = [
    {
      id: "popularity",
      name: t("ratna.sortOptions.popularity", "Most Popular"),
    },
    {
      id: "price-low",
      name: t("ratna.sortOptions.priceLow", "Price: Low to High"),
    },
    {
      id: "price-high",
      name: t("ratna.sortOptions.priceHigh", "Price: High to Low"),
    },
  ...
  const filteredGemstones = gemstones.filter((gemstone) => {
    ...
    const matchesPrice =
      ...
      (priceRange === "5000-10000" &&
        gemstone.price > 5000 &&
        gemstone.price <= 10000) ||
      (priceRange === "10000-20000" &&
        gemstone.price > 10000 &&
        gemstone.price <= 20000) ||
    ...
    const matchesSearch =
      ...
      gemstone.benefits.some((benefit) =>
    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <section className="relative py-20 text-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10 text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">
            {t("ratna.hero.title", "Gemstone Collection")}
          </h1>
          ...
          <p className="text-lg opacity-80 mb-8 max-w-3xl mx-auto">
            {t(
              "ratna.hero.description",
              "Pure natural gemstones for planetary benefits and spiritual development"
            )}
          </p>
          <div className="flex flex-wrap justify-center gap-6 text-sm opacity-90">
            <div className="flex items-center gap-2">
              ...
              <span>
                {t("ratna.hero.features.certified", "Certified Quality")}
              </span>
            </div>
            <div className="flex items-center gap-2">
              <span className="text-2xl">🙏</span>
              <span>
                {t("ratna.hero.features.blessed", "Blessed by Brahmins")}
              </span>
            </div>
            <div className="flex items-center gap-2">
              <span className="text-2xl">✨</span>
              <span>
                {t("ratna.hero.features.benefits", "Planetary Benefits")}
              </span>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white rounded-3xl p-8 shadow-2xl border border-orange-100">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-gray-800 mb-2">
                {t("ratna.search.title", "🔍 Find Your Perfect Gemstone")}
              </h2>
              <p className="text-gray-600">
                {t(
                  "ratna.search.subtitle",
                  "Filter by planet, price and category"
                )}
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-5 gap-6 mb-8">
              <div>
                ...
                <div className="relative">
                  ...
                  <Input
                    placeholder={t(
                      "ratna.search.placeholders.search",
                      "Search gemstone, planet, or benefits..."
                    )}
                    value={searchTerm}
              ...
              <div>
                ...
                >
                  <SelectTrigger className="py-3 border-2 border-orange-200 focus:border-orange-400 rounded-xl">
                    <SelectValue
                      placeholder={t(
                        "ratna.search.placeholders.category",
                        "Select Category"
                      )}
                    />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="all">
                      {t(
                        "ratna.search.options.allCategories",
                        "All Categories"
                      )}
                    </SelectItem>
              ...
              <div>
                ...
                <Select value={priceRange} onValueChange={setPriceRange}>
                  <SelectTrigger className="py-3 border-2 border-orange-200 focus:border-orange-400 rounded-xl">
                    <SelectValue
                      placeholder={t(
                        "ratna.search.placeholders.priceRange",
                        "Select Price"
                      )}
                    />
                  </SelectTrigger>
              ...
              <div>
                ...
                <Select value={sortBy} onValueChange={setSortBy}>
                  <SelectTrigger className="py-3 border-2 border-orange-200 focus:border-orange-400 rounded-xl">
                    <SelectValue
                      placeholder={t(
                        "ratna.search.placeholders.sortBy",
                        "Sort By"
                      )}
                    />
                  </SelectTrigger>
            ...
            <div className="flex flex-wrap justify-center gap-3">
              <div className="text-sm text-gray-600 mr-4">
                {t("ratna.search.quickFilters", "Quick Filters:")}
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-800 mb-4">
              {t("ratna.collection.title", "Available Gemstone Collection")}
            </h2>
            {loading ? (
              <p className="text-gray-600">
                {t("ratna.collection.loading", "Loading gemstones...")}
              </p>
            ) : error ? (
          ...
          {loading ? (
            ...
            <div className="text-center py-20">
              ...
              <h3 className="text-2xl font-bold mb-2 text-red-600">
                {t("ratna.collection.error.title", "Failed to Load Gemstones")}
              </h3>
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="bg-gradient-to-r from-orange-50 to-red-50 px-3 py-2 rounded-lg mb-4 border border-orange-200">
                      <div className="text-xs text-orange-800 font-medium">
                        {t("ratna.labels.worshipFeatures", "Worship Features:")}
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        >
                          {gemstone.discountPercentage ||
                            Math.round(
                              ((gemstone.originalPrice - gemstone.price) /
                    ...
                    <div className="space-y-3">
                      ...
                      >
                        ...
                        {gemstone.inStock
                          ? t("ratna.labels.buyNow", "Buy Now")
                          : t("ratna.labels.outOfStock", "Out of Stock")}
                      </Button>
                    </div>
                  </CardContent>
                </Card>
          ...
          {!loading && !error && filteredGemstones.length === 0 && (
            <div className="text-center py-12">
              <p className="text-gray-500 text-lg">
                {t("ratna.collection.empty", "No gemstones found.")}
              </p>
              <Button
                variant="outline"
                className="mt-4"
      ...
      <section className="py-16 bg-gradient-to-r from-orange-50 to-red-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-800 mb-4">
              {t("ratna.features.title", "Why Choose Our Gemstones?")}
            </h2>
            <p className="text-lg text-gray-600">
              {t(
                "ratna.features.subtitle",
                "Authentic and certified gemstone collection"
              )}
            </p>
          </div>
            ...
            {[
              {
                icon: "✅",
                title: t(
                  "ratna.features.items.certified.title",
                  "Certified Quality"
                ),
                desc: t(
                  "ratna.features.items.certified.desc",
                  "All gemstones are certified"
                ),
              ...
              },
              {
                icon: "🌍",
                title: t(
                  "ratna.features.items.natural.title",
                  "Natural Origin"
                ),
                desc: t(
                  "ratna.features.items.natural.desc",
                  "100% pure natural gemstones"
                ),
              ...
              },
              {
                icon: "🙏",
                title: t(
                  "ratna.features.items.worship.title",
                  "Expert Worship"
                ),
                desc: t(
                  "ratna.features.items.worship.desc",
                  "Mantra chanting by Brahmins"
                ),
              ...
              },
              {
                icon: "📱",
                title: t(
                  "ratna.features.items.consultation.title",
                  "Expert Consultation"
                ),
                desc: t(
                  "ratna.features.items.consultation.desc",
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-800 mb-4">
              {t("ratna.benefits.title", "Benefits of Gemstones")}
            </h2>
            <p className="text-gray-600">
              {t(
                "ratna.benefits.subtitle",
                "Natural gemstones bring positive changes to your life"
              )}
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="text-center hover:shadow-lg transition-shadow border-t-4 border-orange-500">
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-gray-800 mb-2">
                  {t(
                    "ratna.benefits.items.spiritual.title",
                    "Spiritual Benefits"
                  )}
                </h3>
                <p className="text-gray-600">
                  {t(
                    "ratna.benefits.items.spiritual.desc",
                    "Mental peace, meditation focus and spiritual power"
                  )}
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow border-t-4 border-red-500">
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-gray-800 mb-2">
                  {t(
                    "ratna.benefits.items.wealth.title",
                    "Wealth & Prosperity"
                  )}
                </h3>
                <p className="text-gray-600">
                  {t(
                    "ratna.benefits.items.wealth.desc",
                    "Business success, wealth growth and financial stability"
                  )}
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow border-t-4 border-purple-500">
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-bold text-gray-800 mb-2">
                  {t("ratna.benefits.items.health.title", "Health Benefits")}
                </h3>
                <p className="text-gray-600">
                  {t(
                    "ratna.benefits.items.health.desc",
                    "Physical health, mental balance and protection from negativity"
                  )}
                </p>
              </CardContent>
            </Card>
      ...
      <section className="py-16 bg-gradient-to-r from-orange-600 to-red-500 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            {t(
              "ratna.cta.subtitle",
              "Get authentic gemstones for planetary benefits"
            )}
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              {t("ratna.cta.call", "Call: +91 9700380000")}
            </Button>
          </div>
        </div>
      </section>
          ...
          <Card className="w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            <CardHeader className="bg-gradient-to-r from-orange-600 to-red-600 text-white">
              <CardTitle className="text-2xl flex items-center justify-between">
                🛒 {t("ratna.checkout.title", "Checkout")} -{" "}
            ...
            <CardContent className="p-6">
              ...
              <div className="bg-orange-50 p-4 rounded-lg mb-6 border border-orange-200">
                <h3 className="font-bold text-lg text-orange-800 mb-2">
                  📋 {t("ratna.checkout.orderSummary", "Order Summary")}
                </h3>
              ...
              <form onSubmit={handleCheckoutSubmit} className="space-y-4">
                <div className="text-center mb-6">
                  <h3 className="text-xl font-bold text-gray-800 mb-2">
                    📝{" "}
                    {t("ratna.checkout.deliveryInfo", "Delivery Information")}
                  </h3>
                  <p className="text-gray-600">
                    {t(
                      "ratna.checkout.deliveryDesc",
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">
                      📞{" "}
                      {t(
                        "ratna.checkout.alternativeMobile",
                        "Alternative Mobile"
                      )}
                    </label>
                    <Input
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">
                    📝{" "}
                    {t(
                      "ratna.checkout.specialInstructions",
                ...
                <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                  <h4 className="font-bold text-blue-800 mb-2">
                    📌{" "}
                    {t("ratna.checkout.importantInfo", "Important Information")}
                  </h4>
                  <div className="text-sm text-blue-700 space-y-1">
                    <p>
                      •{" "}
                      {t(
                        "ratna.checkout.freeShipping",
                    ...
                    <p>
                      •{" "}
                      {t(
                        "ratna.checkout.videoWorship",
                        "Video of worship ceremony will be shared on WhatsApp"
                      )}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4 pt-4">
                  ...
                  >
                    {t(
                      "ratna.checkout.proceedToPayment",
                      "💳 Proceed to Payment"
                    )}
                  </Button>
                </div>
